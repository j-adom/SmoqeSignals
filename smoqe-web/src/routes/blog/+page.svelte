...
<svelte:head>
	...
	<meta name="description" content="Recipes, pit tips, and stories from the Smoqe Signals BBQ truck and trail." />
</svelte:head>

<div class="rise">
	<section class="border-b border-paper-line">
		<div class="container-wide pt-[60px]">
			<div class="mb-3.5 flex items-center gap-3"><Tristar lg /><span class="eyebrow text-flame">From the Pit</span></div>
			<h1 class="display text-[clamp(2.5rem,7vw,4.75rem)]">Smoke signals</h1>
			<p class="mb-12 mt-4 max-w-xl text-lg leading-relaxed text-ink-soft">
	...
	<section class="py-14">
		<div class="container-wide">
			{#if featured}
				...
				>
					<div class="min-h-[320px] bg-paper-2">
					...
					<div class="flex flex-col justify-center p-10">
						<div class="mb-3.5 flex items-center gap-2.5">
							...
							<span class="text-[13px] font-semibold text-ink-soft">{formatDate(featured.date)}</span>
						</div>
						<h2 class="display mb-3.5 text-[clamp(1.6rem,3.4vw,2.375rem)]">{featured.title}</h2>
						<p class="mb-[22px] text-base leading-relaxed text-ink-soft">{featured.excerpt}</p>
